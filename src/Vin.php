...
use Crassq\Vin\Services\CountryService;
use Crassq\Vin\Services\ManufacturerService;
use Crassq\Vin\Services\ModelYearService;
use Crassq\Vin\Services\RegionService;
use Exception;
...
class Vin
{
    ...
    public function parse(string $vin): static
    {
        ...
        if (!preg_match(self::REGEX, $vin, $matches)) {
            throw new InvalidArgumentException(sprintf(
                trans('vin_messages.environment.not_a_valid_VIN'),
                $vin
            ));
        }
    ...
    public function getWmi(string $vin = null): string
    {
        return $vin ? $this->parse($vin)->wmi :
            ($this->wmi ?: throw new InvalidArgumentException(trans('vin_messages.environment.VIN_is_not_set')));
    }
    ...
    public function getVds(string $vin = null): string
    {
        return $vin ? $this->parse($vin)->vds :
            ($this->vds ?: throw new InvalidArgumentException(trans('vin_messages.environment.VIN_is_not_set')));
    }
    ...
    public function getVis(string $vin = null): string
    {
        return $vin ? $this->parse($vin)->vis :
            ($this->vis ?: throw new InvalidArgumentException(trans('vin_messages.environment.VIN_is_not_set')));
    }
    ...
    public function getManufacturer(string $vin = null): string
    {
        return $vin ? $this->parse($vin)->manufacturer :
            ($this->manufacturer ?: throw new InvalidArgumentException(trans('vin_messages.environment.VIN_is_not_set')));
    }
    ...
    public function getModelYear(string $vin = null): array
    {
        return $vin ? $this->parse($vin)->modelYear :
            ($this->modelYear ?: throw new InvalidArgumentException(trans('vin_messages.environment.VIN_is_not_set')));
    }
    ...
    public function getRegion(string $vin = null): string
    {
        return $vin ? $this->parse($vin)->region :
            ($this->region ?: throw new InvalidArgumentException(trans('vin_messages.environment.VIN_is_not_set')));
    }
    ...
    public function getCountry(string $vin = null): string
    {
        return $vin ? $this->parse($vin)->country :
            ($this->country ?: throw new InvalidArgumentException(trans('vin_messages.environment.VIN_is_not_set')));
    }
